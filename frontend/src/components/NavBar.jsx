...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between py-5 font-medium gap-6 ">
      <Link to='/'>
        <img src={assets.logo} className="w-50 shrink-0" alt="Logo"  />
      </Link>

      <ul className="hidden md:flex gap-10 text-sm text-gray-700 items-center">
      ...
      <div className={`absolute top-0 right-0 bottom-0 bg-white transition-transform transform ${visible ? 'translate-x-0' : 'hidden'} w-full`}>
